...
class bugs(Task):
    ...
    def make(self):
        webbrowser.open("http://github.com/trentm/testlib/issues")

class site(Task):
    """open project page"""
    def make(self):
        webbrowser.open("http://github.com/trentm/testlib")

class pypi(Task):
    """open project page"""
    def make(self):
        webbrowser.open("http://pypi.python.org/pypi/testlib/")

class cut_a_release(Task):
    """automate the steps for cutting a release
    
    See '{eol}/docs/devguide.md' for details.
    """
    proj_name = "testlib"
    version_py_path = "lib/testlib.py"
    version_module = "testlib"
...
class pypi_upload(Task):
    ...
    def make(self):
        ...
        url = "http://pypi.python.org/pypi/testlib/"
        import webbrowser
